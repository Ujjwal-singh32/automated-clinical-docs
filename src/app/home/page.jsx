...
export default function MedicareDashboard() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Fixed Add New Patient Button - Bottom Left */}
      <button className="fixed bottom-6 left-6 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-medium flex items-center space-x-2 transition-all duration-200 shadow-lg hover:shadow-xl z-50"
